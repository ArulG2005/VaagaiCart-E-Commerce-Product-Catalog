...
export const createOrder = order => async(dispatch) => {
    try {
       ...
       const {data} = await axios.post(`http://localhost:8080/api/v1/order/new`, order)
...
export const userOrders = async(dispatch) => {
    try {
       ...
       const {data} = await axios.get(`http://localhost:8080/api/v1/myorders`)
...
export const deleteOrder = id => async(dispatch) => {
    try {
       ...
       await axios.delete(`http://localhost:8080/api/v1/admin/order/${id}`)
...
export const updateOrder = (id, orderData)  => async(dispatch) => {
    try {
       ...
       const { data} = await axios.put(`http://localhost:8080/api/v1/admin/order/${id}`, orderData)
