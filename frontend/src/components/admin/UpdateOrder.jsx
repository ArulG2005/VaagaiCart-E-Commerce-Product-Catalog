...
const isPaid = (orderDetail?.paymentInfo?.status || '') === 'succeeded';
                                ...
                                {orderItems && orderItems.map(item => (
                                    ...
                                    <div className="row my-5">
                                        <div className="col-4 col-lg-2">
                                            <img src={item.product.images[0].imageUrl} alt={item.product.name} height="45" width="65" />
                                        </div>

                                        <div className="col-5 col-lg-5">
                                            <Link to={`/product/${item.product.name}`}>{item.product.name}</Link>
                                        </div>
